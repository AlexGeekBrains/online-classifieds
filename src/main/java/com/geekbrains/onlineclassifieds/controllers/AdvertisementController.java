...
import com.geekbrains.onlineclassifieds.validators.converters.AdvertisementConverter;
...
public class AdvertisementController {
    ...
    @GetMapping()
    public List<Advertisement> showAdvertisements() {
        return advertisementServiceImpl.getAllAdvertisements();
    }
